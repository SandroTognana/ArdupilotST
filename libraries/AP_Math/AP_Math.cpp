...
// a variant of sqrt() that checks the input ranges and ensures a
...
// a faster variant of atan.  accurate to 6 decimal places for values between -1 ~ 1 but then diverges quickly
