...
#define ROLL_PITCH_STABLE_OF        3       // pilot inputs roll, pitch angles which are mixed with optical flow based position controller lean angles
...
#define ROLL_PITCH_HYBRID			8		// SANDRO:
...
#define HYBRID 14						// SANDRO: modo IBRIDO
#define NUM_MODES 15
